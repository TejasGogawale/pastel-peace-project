    ...
    <Card className="p-6 shadow-soft border-border bg-card">
      ...
      <div className="space-y-3">
        {patients.map((patient) => (
          <Link key={patient.id} to={`/dashboard/counsellor/patient-dashboard/${patient.id}`}>
            <div className="p-4 rounded-lg bg-muted/50 hover:bg-muted/70 transition-smooth cursor-pointer">
